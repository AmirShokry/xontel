...
const firebaseConfig = {
  ...
  authDomain:
    import.meta.env?.VITE_AUTH_DOMAIN || process?.env.EXPO_PUBLIC_AUTH_DOMAIN,
  projectId:
    import.meta.env?.VITE_PROJECT_ID || process?.env.EXPO_PUBLIC_PROJECT_ID,
  storageBucket:
  ...
  appId: import.meta.env?.VITE_APP_ID || process?.env.EXPO_PUBLIC_APP_ID,
};
